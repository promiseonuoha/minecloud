...
export default function SideBar({ left, onClick }: any) {
  ...
  return (
    <div
      style={{ left: left }}
      className="w-[215px] h-[85vh] duration-300 max-[670px]:absolute max-[670px]:z-50 bg-white rounded-lg border border-solid border-[rgba(0,0,0,0.1)] flex flex-col justify-between p-[15px]"
    >
