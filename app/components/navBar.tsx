...
import { faMagnifyingGlass, faArrowRightFromBracket, faSliders } from '@fortawesome/free-solid-svg-icons';
      ...
      <nav className="w-full flex justify-between items-center">
        <div className="flex gap-6">
          ...
          <div className="hidden max-[670px]:block" onClick={onClick}>
            <FontAwesomeIcon icon={faSliders} className="w-4 h-4 text-[rgba(0,0,0,0.9)] cursor-pointer" />
          </div>
            ...
            {navLinks.map((item) => {
              return (
                <Link
                  ...
                  style={{
                    backgroundColor: `${checkPath(item.path) ? 'white' : 'transparent'}`,
                    color: `${checkPath(item.path) ? 'rgb(29,78,216)' : 'rgba(0,0,0,0.7)'}`,
                  }}
                >
          ...
          <div className="relative">
            <div className="w-[210px] h-[35px] bg-white rounded cursor-pointer flex">
              <div className="w-9 h-[35px] rounded flex justify-center items-center">
                <FontAwesomeIcon icon={faMagnifyingGlass} className="w-4 h-3 text-[rgba(0,0,0,0.8)]" />
              </div>
            ...
            {focused && <Search value={searchValue} email={userDetails.email} />}
          </div>
          {userDetails && (
            <div className="relative">
              <div
              ...
              >
                <div className="w-full flex gap-1 items-center px-3">
                  ...
                  <p className="text-[13px] text-[rgba(0,0,0,0.8)] font-medium">{userDetails.name}</p>
                </div>
                <p className="text-xs py-[6px] text-[rgba(0,0,0,0.8)] font-medium px-3">Signed In As: {userDetails.email}</p>
                <div className="flex flex-col w-full">
                  ...
                  >
                    Favourite Files
                    <FontAwesomeIcon icon={faHeart} className="w-[10px] h-[10px] text-[rgba(0,0,0,0.8)]" />
                  </Link>
                  <Link
                    onClick={() => toggleClip()}
                    href={'/contact&'}
                  ...
                  >
                    Privacy Policy
                    <FontAwesomeIcon icon={faAddressBook} className="w-[10px] h-[10px] text-[rgba(0,0,0,0.8)]" />
                  </Link>
                  <button
                    onClick={() => {
                      toggleClip();
                  ...
                  >
                    SignOut
                    <FontAwesomeIcon icon={faArrowRightFromBracket} className="w-[10px] h-[10px] text-[rgba(0,0,0,0.8)]" />
                  </button>
                </div>
              </div>
            </div>
