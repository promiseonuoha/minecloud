  ...
  return (
    <html lang="en">
      <body className={inter.className}>
        <main className="w-full h-screen bg-transparent relative before:content-[''] before:absolute before:w-full before:h-[50vh] before:-z-10 before:bottom-0 before:left-0 before:bg-white/90 p-7 max-[700px]:p-5">
